...
const AppointmentForm = () => {
  ...
  const defaultDoctors = {
    ...
    Oncology: [
      { firstName: "Aditya", lastName: "Iyer" },
      { firstName: "Kavya", lastName: "Desai" },
    ],
    Radiology: [
      { firstName: "Siddharth", lastName: "Joshi" },
      { firstName: "Ishita", lastName: "Malhotra" },
    ],
    "Physical Therapy": [
    ...
    Dermatology: [
      { firstName: "Rahul", lastName: "Chopra" },
    ...
    <>
      <div className="container form-component appointment-form">
        <div className="appointment-heading">
          <span className="eyebrow">A calmer way to get care</span>
          <h2>Book your appointment</h2>
          <p>Tell us a little about yourself and we will help you find the right department and doctor.</p>
        </div>
        <form onSubmit={handleAppointment}>
          ...
          <div>
            ...
            >
              ...
              {[...(defaultDoctors[department] || []), ...doctors
                .filter((doctor) => doctor.doctrDptmnt === department)]
                .filter(
                  (doctor, index, departmentDoctors) =>
                    departmentDoctors.findIndex(
                      (item) =>
